...
1. Host the web application online. I have hosted a version of web application hosted on Pythonanywhere, enabling CRUD operations two database tables 'Orders' and 'Customers'. Due to time constraints, I did not have time to implement login.html page, as I encountered some errors and did not have time to troubleshoot them. 
